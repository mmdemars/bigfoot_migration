...
d3.json("https://everythingtacos.s3.amazonaws.com/best_tacos.geojson").then(function (data) {
  console.log(data);
  L.geoJSON(data, {
...
d3.json("https://everythingtacos.s3.amazonaws.com/bigfoot_movement.geojson").then(function (data) {
